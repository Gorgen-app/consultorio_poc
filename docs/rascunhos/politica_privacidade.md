...
A sua privacidade e a proteção dos seus dados são a nossa maior prioridade. Esta Política de Privacidade descreve como o **Sistema Gorgen** ("nós", "nosso"), operado sob a responsabilidade do Dr. André Gorgen, coleta, utiliza, armazena, compartilha e protege os seus dados pessoais, em estrita conformidade com a **Lei Geral de Proteção de Dados Pessoais (LGPD - Lei nº 13.709/2018)** e as normativas do **Conselho Federal de Medicina (CFM)**.

Ao utilizar os nossos serviços, você confia-nos as suas informações. Entendemos a responsabilidade que isso acarreta e comprometemo-nos a tratar os seus dados com o máximo de cuidado, sigilo e segurança.
