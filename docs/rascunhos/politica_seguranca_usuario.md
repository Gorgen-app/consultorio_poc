---
title: "Política de Segurança do Usuário"
...
- **Seja único:** Não reutilize senhas de outros sites ou serviços. Se uma senha sua vazar em outro lugar, sua conta Gorgen permanecerá segura.
...
- **Encerramento de sessão (Logout):** Ao terminar de usar o Gorgen, especialmente em um computador compartilhado, sempre clique em **"Sair"** ou **"Logout"** para encerrar sua sessão de forma segura.
...
2.  **Reporte o incidente** imediatamente ao nosso canal de suporte, fornecendo o máximo de detalhes possível.
    - **Canal de Suporte:** [Definir e-mail ou portal de suporte, ex: segurança@gorgen.com.br]
