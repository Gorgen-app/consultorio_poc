                        ...
                        <TableCell className="text-right">
                          <div className="flex items-center justify-end gap-1" onClick={(e) => e.stopPropagation()}>
                            <Button
                              variant="ghost"
                              size="sm"
                              tooltip="Abrir prontuário do paciente" onClick={() => setLocation(`/prontuario/${paciente.id}`)}
                            ...
                            <Button
                              variant="ghost"
                              size="sm"
                              tooltip="Editar registro" onClick={() => handleEditar(paciente)}
                            ...
                            <Button
                              variant="ghost"
                              size="sm"
                              tooltip="Excluir item selecionado" onClick={() => handleExcluir(paciente)}
