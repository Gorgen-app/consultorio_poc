...
## 🎨 GORGEN 3.9.80 - Implementação dos Modais Redesenhados

### Modal de Evolução (Nova Evolução)
- [ ] Refatorar DialogContent com largura 1600px (3x mais largo)
- [ ] Implementar layout de 3 colunas: SOAP (flex) + Upload (280px) + Histórico (280px)
- [ ] Criar cabeçalho do paciente com avatar, nome, CPF, nascimento, ícone prontuário
- [ ] Adicionar timer discreto no header
- [ ] Implementar atalhos de teclado ultra-discretos
- [ ] Criar área de upload de documentos com drag-and-drop
- [ ] Adicionar coluna de histórico rápido (últimas evoluções)
- [ ] Reorganizar footer com botões alinhados horizontalmente
- [ ] Aplicar paleta de cores oficial Gorgen

### Modal de Agendamento (Editar Atendimento) ✅ IMPLEMENTADO (28/01/2026)
- [x] Refatorar DialogContent com largura 720px
- [x] Criar header com tipo + status badge + botão fechar
- [x] Implementar seção de dados do paciente (avatar, nome, WhatsApp, CPF, nascimento)
- [x] Adicionar botão "Ver Prontuário" no header do paciente
- [x] Criar cards de Data/Hora e Local lado a lado
- [x] Implementar stepper de 5 etapas (Agendado → Confirmado → Aguardando → Em Atendimento → Encerrado)
- [x] Exibir TODOS os 9 botões de ação visíveis simultaneamente
...
- [x] Botões desabilitados ficam visíveis (opacity 0.4)
- [x] Aplicar paleta de cores oficial Gorgen
